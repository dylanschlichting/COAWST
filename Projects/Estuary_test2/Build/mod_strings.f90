...
!
        ...
        character (len=80)  :: my_fc = "/sw/eb/sw/impi/2019.9.304-iccifort-2020.4.304/intel64/bin/mpiifort"
        character (len=512) :: my_fflags = "-fp-model precise -ip -O3 -traceback -free"
!
        character (len=256) :: Adir = "/scratch/user/dylan.schlichting/COAWST/ROMS/Functionals"
        character (len=256) :: Hdir = "/scratch/user/dylan.schlichting/COAWST/Projects/Estuary_test2"
        character (len=256) :: Hfile = "estuary_test2.h"
        character (len=256) :: Rdir = "/scratch/user/dylan.schlichting/COAWST"
!
